          ...
          <div class="row m-sm-4 m-0">
            ...
            <div class="col-md-5">
              <dl class="row mb-2">
                ...
                <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                  <input type="text" name="date" id="date" value="{{$invoice->date}}" class="form-control w-px-150 date-picker" placeholder="YYYY-MM-DD" />
                </dd>
                <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end ps-0">
                  <span class="fw-normal">Due Date:</span>
                </dt>
                <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                  <input type="text" name="dueDate" id="dueDate" value="{{$invoice->due_date}}" class="form-control w-px-150 date-picker" placeholder="YYYY-MM-DD" />
                </dd>
              </dl>
            </div>
          </div>
          ...
          <div class="row px-0 px-sm-4">
            <div class="col-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" rows="2" name="description" id="description" placeholder="Invoice note">{{$invoice->description}}</textarea>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="col-lg-3 col-12 invoice-actions">
    <div class="card mb-4">
      <div class="card-body">
        ...
        <button id="submitData" type="button" class="btn btn-success d-grid w-100">Update Invoice</button>
      </div>
    </div>
    <div>
